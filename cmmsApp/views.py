...
from .utils_contact import country_name_from_alpha2, normalize_phone_and_country
...
# CAPTCHA check 
    ...
    subject = "New LV, MV, and HV Switchgear Inquiry"
    text_body = (
        "A new LV, MV, and HV Switchgear inquiry request was submitted.\n\n"
        f"Submitted: {ts}\n"
    ...
    html_body = f"""
        <h2 style="margin:0 0 8px">New LV, MV, and HV Switchgear Inquiry</h2>
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        # Email body
        subject = "New website contact submission for LV, MV, and HV Switchgear"
        text_body = "\n".join(
            [
                "New contact submission for LV, MV, and HV Switchgear:",
...
DOC_REGISTRY = {
    _norm_key("lv-mv-hv"): DOWNLOAD_DIR / "lv-mv-hv.pdf",
    _norm_key("lv-mv-hv"):
        DOWNLOAD_DIR / "lv-mv-hv.pdf",
    _norm_key("lv-mv-hv"): DOWNLOAD_DIR / "lv-mv-hv.pdf",
}
